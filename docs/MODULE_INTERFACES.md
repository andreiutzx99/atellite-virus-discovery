...
| Coverage/composition/ORF summary | Supplied sequence/alignment artifacts | Descriptive measurements with units and missing-data status | Combined reporting stage pending; no functional interpretation implied |
...
| Clustering/catalogue/FASTA export | Independently supplied reviewed sequence records | Versioned record IDs, membership and export manifest | Not implemented in this milestone |
